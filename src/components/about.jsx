export default function About() {
    return(
        ...
        <section className="bg-gradient-to-r from-orange-950 to-black px-3.5 py-4">
            <div>
                <h1 className="text-white text-center md:text-2xl">About Me</h1>
            </div>
            ...
            <div>
                ...
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-3xl mt-4">Contact Me</button>
            </div>
        </section>
        </>
    )
