export default function About() {
    return(
        ...
        <section className="px-6 py-10">
            <div>
                <h1 className="text-white font-semibold text-center border-b-2 mx-28 text-xl pb-2 md:text-2xl md:mx-40">About Me</h1>
            </div>
            ...
            <div>
                ...
                <button className="bg-red-500 hover:bg-white text-white hover:text-orange-600 font-bold py-2 px-4 rounded mt-4">Contact Me</button>
                </div>
