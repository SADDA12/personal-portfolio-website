...
import profilephoto from "../assets/profilephoto-me.png";
...
export default function Hero() {
    return(
        ...
        <div className="flex justify-center items-center">
            <img src={profilephoto} alt="my profile pic" className="bg-white rounded-full w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48"/>
        </div>
